resource "azurerm_resource_group" "adontierrg" {
  name     = "adorg"
  location = "eastus"
  tags = {
    Env       = "Dev"
...
resource "azurerm_virtual_network" "ntiervnet" {
  name                = "adovnet"
  resource_group_name = azurerm_resource_group.adontierrg.name
  location            = azurerm_resource_group.adontierrg.location
  ...
  depends_on = [
    azurerm_resource_group.adontierrg
  ]
}
